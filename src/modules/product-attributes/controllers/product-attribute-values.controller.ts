...
export var getProductAttributeValues = function (req, res, next) {
...
export var addProductAttributeValue = function (req, res, next) {
        ...
        ProductAttributeValueModel.findOne({ ProductAttribute: productAttribute, Key: req.body.productAttributeValue }).exec(function (err, productAttributeValue) {
            if (err) {
                ...
                productAttributeValue.save(
                    function (err, productAttributeValue, numAffected) {
                        if (err) {
                            logger.error(err);
                            res.writeHead(500);
                            res.end(err);
...
export var deleteProductAttributeValue = function (req, res, next) {

    if (productAttributeValueHasBeenUsed(req.params.productAttributeValueId)) {
...
export var productAttributeValueHasBeenUsed = function (productAttributeValueId: string): boolean {
    return true;
}
