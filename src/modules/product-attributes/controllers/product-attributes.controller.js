...
exports.getProductAttributes = function (req, res, next) {
...
exports.addProductAttribute = function (req, res, next) {
    ...
    ProductAttributeModel.findOne({ 'Key': newProductAttribute.Key }).exec(function (err, productAttribute) {
        ...
        if (productAttribute) {
            ...
            productAttribute.save(function (err, productAttribute, numAffected) {
                if (err) {
                    logger.error(err);
                    res.writeHead(500);
                    res.end(err);
...
exports.deleteProductAttribute = function (req, res, next) {
    ProductAttributeModel.remove({ Key: req.params.productAttribute }, function (err, productAttribute) {
        if (err) {
            logger.error(err);
            res.writeHead(500);
            res.end(err);
