...
export
    var ProductAttributeValueModel = mongoose.model('ProductAttributeValue', productAttributeValueSchema);


var getNextDisplayIndex = (productAttributeId: string, callback: any, thisObject: any) => {
