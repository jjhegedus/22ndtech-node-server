...
describe("Add product 0", function () {
    var postRequest0;
    beforeEach(function () {
        postRequest0 = chakram.post(config.baseUrl + '/products', products[0]);
    });
    ...
    it('should get the product created', function () {
        return postRequest0.then(function (response) {
            return chakram.get(config.baseUrl + '/products/' + response.body.id)
    ...
    it("should delete the product created", function () {
        return postRequest0.then(function (response) {
            return chakram.delete(config.baseUrl + '/products/' + response.body.id, response.body)
...
describe("Add an array of products", function () {
    var postRequest1;
    beforeEach(function () {
        postRequest1 = chakram.post(config.baseUrl + '/products', products);
    });
    it("should just print the returned data", function () {
    ...
    it('should get all products', function () {
        return chakram.get(config.baseUrl + '/products')
