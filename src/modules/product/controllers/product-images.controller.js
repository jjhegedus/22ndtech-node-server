...
exports.sign = function (req, res, next) {
    try {
        let s3 = new aws.S3();
        let awsS3 = new aws_s3_lib_1.AwsS3();
        let options = {
...
exports.getAuthorizationHeader = function (req, res, next) {
    let s3 = new aws.S3();
    let awsS3 = new aws_s3_lib_1.AwsS3();
    let headers = {};
...
exports.deleteMainProductImage = function (req, res, next) {
    try {
        let options = {
            Bucket: config.aws.mainSiteBucket,
            Key: 'img/' + req.query.product_id + "/" + req.query.file_name
...
exports.getMainProductImage = function (req, res, next) {
...
exports.getProductImages = function (req, res, next) {
    this.productId = req.params.productId;
    try {
        let options = {
            Bucket: config.aws.mainSiteBucket,
...
exports.deleteProductImage = function (req, res, next) {
...
exports.moveDown = function (req, res, next) {
    var imageId = req.params.imageId;
    ProductImageModel.findByIdAndUpdate(imageId, { $set: { DisplayIndex: -1 } })
        .populate('Product')
        .exec((err, doc) => {
...
exports.moveTo = function (req, res, next) {
    var imageId = req.params.imageId;
    var newDisplayIndex = req.params.newDisplayIndex;
    ProductImageModel.findById(imageId)
        .populate('Product')
        .exec((err, doc) => {
        if (err) {
        }
                ...
                ProductImageModel.find({
                    ...
                    if (err) {
                        ...
                        for (var i1 = 0; i1 < docs1.length; i1++) {
                            var rec = docs1[i1];
                            ProductImageModel.findByIdAndUpdate(rec._id, {
                                $inc: { DisplayIndex: 1 }
                            })
                                .exec((err, doc) => {
                                if (err) {
