...
exports.moveTo = function (req, res, next) {
    ...
    ProductCategoryModel
        ...
        if (newDisplayIndex < oldDisplayIndex) {
            ...
            // set the old record displayIndex to -1
            ProductCategoryModel.findByIdAndUpdate(doc._doc._id, { $set: { DisplayIndex: -1 } })
                .exec((err, doc3) => {
                if (err) {
                    return next(err);
                }
...
exports.getProductCategoryImageSignature = function (req, res, next) {
    try {
        let s3 = new aws.S3();
...
exports.updateProductCategory = function (req, res, next) {
    ...
    ProductCategoryModel.findOneAndUpdate({ Key: updatedProductCategory.Key }, { $set: { ImageUrl: updatedProductCategory.ImageUrl } }, { new: true }, function (err, newProductCategory) {
        if (err) {
            return next(err);
        }
        else {
